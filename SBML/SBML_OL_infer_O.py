...
_create_info_folder(upper_board_writer, args, files_to_save=["./exp2/exp2_OL_infer_O.py", "dataset.py", "utils/config.py", "models/__init__.py"])
...
post_message('#alarm', f'exp2_OL_infer_O.py [{upper_board_writer.log_dir}] done! UF1:{total_uf1}, UAR:{total_uar}, WAR:{total_war}')